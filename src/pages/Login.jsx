...
const Login = ({ handleAuth }) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-y-5 bg-gray-100 h-screen">
      ...
      <div className="max-w-md w-full bg-white flex flex-col gap-y-5 px-10 py-5 rounded-lg shadow-md">
        <div>
          <InputField
        ...
        <div>
          <InputField
            ...
            fieldName="password"
            onChange={handleChange}
            error={state.errorMsg && state.errorMsg.includes("Password") ? state.errorMsg : ""}
          />
        </div>
        ...
        <div className="flex justify-end">
          <div>
            <p className="text-cyan-600 cursor-pointer">Forgot Password?</p>
          </div>
        </div>
        <div className="text-center">
          <button className="bg-black text-white px-10 py-2 rounded" onClick={handleLogin}>
            Login
          </button>
        </div>
      </div>
